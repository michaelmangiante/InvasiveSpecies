...
inData <- read.csv(file="animals_HUC2Species_CircularFlowData.csv", stringsAsFactors = FALSE)
...
#print jpeg
jpeg("Animals_CircularPlot_FirstHUC2Occurance.jpeg", width=11,heigh=11, units="in", res = 600)
