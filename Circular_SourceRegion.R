...
inData <- read.csv(file="Plants_USFirstOccurance_CircularFlowData.csv", stringsAsFactors = FALSE)
...
#print jpeg
jpeg("Plants_CircularPlot_FirstUSOccurance.jpeg", width=11,heigh=11, units="in", res = 600)
